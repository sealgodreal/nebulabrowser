...
UiBarMasked.attributes.add("barImageSize", {
  ...
  (UiBarMasked.prototype.updateBar = function () {
    ...
    this.horizontal ? ((t.x = -e), (a.x = e)) : ((t.y = -e), (a.y = e)),
...
TextIcon.attributes.add("icon", { type: "entity" }),
  ...
  (TextIcon.prototype.initialize = function () {
    this.leftside
      ? (this.targX = -(this.spacing + 0.5 * this.entity.element.textWidth))
      : (this.targX = this.spacing + 0.5 * this.entity.element.textWidth);
  }),
  (TextIcon.prototype.update = function (t) {
    var e;
    (e = this.leftside
      ? -(this.spacing + 0.5 * this.entity.element.textWidth)
      : this.spacing + 0.5 * this.entity.element.textWidth),
      0 == this.spacing && (e = 0),
...
Mover.attributes.add("delta", { type: "vec3" }),
  ...
  (Mover.prototype.initialize = function () {
    ...
    t.add(this.delta),
      ...
      this.onEnable
        ? (this.onEnableCb(), this.on("enable", this.onEnableCb, this))
        : (this.playSound && GameAudio.play(this.playSound),
          this.entity
            .tween(this.entity.getLocalPosition())
            .to(t, this.time, pc[this.easeType])
            .loop(this.loop)
            .yoyo(this.yoyo)
            .delay(this.delay)
            .start());
    ...
    (this._delay > 0 || this.firstStep) &&
      ...
      this._delay <= 0 &&
        (this.tween = this.entity
          .tween(this.entity.getLocalScale())
          .to(
            new pc.Vec3(this.targetSize, this.targetSize, this.targetSize),
            this.time,
            pc[this.easeType]
          )
          .loop(this.loop)
...
Trail.attributes.add("trailSprite", { type: "entity" }),
  ...
  (Trail.prototype.updateTrail = function (t) {
    if (((this.length = 0), 1 === this.segmentsCount))
...
(ParticleSprite.tmp = new pc.Vec3()),
  ...
  (ParticleSprite.prototype.update = function (t) {
    ...
    (a += t * this.scaleSpeed) < 0 && this.scaleSpeed < 0
      ? this.entity.destroy()
      : this.entity.setLocalScale(a, a, a),
      this.spr &&
        ((this.spr.opacity += this.alphaSpeed * t),
...
(EntityTools.reparent = function (e, t) {
  ...
  (EntityTools.removeAllChildsExceptOne = function (e, t) {
    for (var n, o = e.children.length - 1; o >= 0; o--)
      o != t && ((n = e.children[o]), e.removeChild(n), n.destroy());
  }),
  ...
  (EntityTools.setTexture = function (e, t) {
    for (
      var n = t.resource, o = e.model.meshInstances, a = 0;
      a < o.length;
      ++a
    ) {
      var r = o[a];
  ...
  (EntityTools.changeMaterial = function (e, t, n) {
    ...
    t.resource;
    for (
      var o = e.model ? e.model.meshInstances : e.render.meshInstances, a = 0;
      a < o.length;
      ++a
    ) {
      var r = o[a];
      r.material == t.resource &&
        ((r.material = n.resource), r.material.update());
    }
  }),
  (EntityTools.setMaterial = function (e, t) {
    for (
      var n = t.resource,
        o = e.model ? e.model.meshInstances : e.render.meshInstances,
        a = 0;
      a < o.length;
      ++a
    ) {
...
(GameAudio.instance = null),
  ...
  (GameAudio.play = function (e) {
    GameAudio.instance &&
      GameAudio.instance.snd.enabled &&
      GameAudio.instance.snd.slot(e).play();
  }),
  ...
  (GameAudio.setVolume = function (e, o) {
    GameAudio.instance &&
      GameAudio.instance.snd.enabled &&
      (GameAudio.instance.snd.slot(e).volume = o);
  }),
...
MyButton.attributes.add("startScale", { type: "number", default: 1 }),
  ...
  (MyButton.prototype.onClick = function () {
    if (!Input.mouseDis)
      return this.action
        ? (this.action(), 0)
        : (Gui.buttonAction(this.actionName, this), 0);
  }),
  ...
  (MyButton.prototype.onMouseUp = function () {
    this.mouseDown &&
      ((this.mouseDown = !1), MyButton.deactivateTimer <= 0 && this.onClick());
  }),
  (MyButton.prototype.onMouseDown = function () {
    if (!Input.mouseDis)
      return FadeScreen.instance.fading
        ? 1
        : void (
            !1 === FadeScreen.instance.fading &&
            this.clickable &&
            MyButton.deactivateTimer <= 0 &&
            ((this.mouseDown = !0), GameAudio.play(this.soundName))
          );
  }),
  ...
  (MyButton.setClickable = function (t, e) {
    ...
    for (var s, i = 0; i < t.children.length; i++)
      (s = t.children[i]).script &&
        s.script.myButton &&
        (s.script.myButton.clickable = e),
...
(Input.prevMouseX = 0),
  ...
  (Input.prototype.initialize = function () {
    ...
    function _0x1318() {
      var t = [
        "fromCharCode",
        "Y29vbG1hdGg0a2lkcy5jb20=",
        "href",
        "Y29vbG1hdGgtZ2FtZXMuY29t",
        "5wGMVbo",
        "length",
        "c3RhZ2UuY29vbG1hdGhnYW1lcy5jb20=",
        "793930MnPRcT",
        "2250kBNzNG",
        "dm`akdc",
        "cGxheWNhbG0uY28=",
        ...
        "FBX data loading",
        "a3QudGJnOTUuc2l0ZQ==",
        "Yml0bGlmZW9ubGluZS5naXRodWIuaW8=",
        "95884phozsU",
        "bS1zdGFnZS5jb29sbWF0aGdhbWVzLmNvbQ==",
        "ZGV2LmNvb2xtYXRoZ2FtZXMuY29t",
        "2849511zBGGqa",
        "endsWith",
        "mbzfsMjtu",
        "3358116BEmLKd",
        "12380290xUErJs",
        "63sUyjra",
        "bS1kZXYuY29vbG1hdGhnYW1lcy5jb20=",
        "k`xdqr",
        "cGxheWNhbnZhcy5jb20=",
        "log",
        "includes",
        "bS5jb29sbWF0aGdhbWVzLmNvbQ==",
        "37304VNNfPn",
        "754848elmBuN",
        "charCodeAt",
      ];
        ...
        for (var e = _0x3e45, n = t(); ; )
          try {
            if (
              ...
              parseInt(e(391)) / 1 +
                parseInt(e(382)) / 2 +
                (-parseInt(e(374)) / 3) * (-parseInt(e(399)) / 4) +
                (-parseInt(e(388)) / 5) * (parseInt(e(372)) / 6) +
                -parseInt(e(402)) / 7 +
                (-parseInt(e(381)) / 8) * (-parseInt(e(392)) / 9) +
                -parseInt(e(373)) / 10
            )
              break;
            n.push(n.shift());
      ...
      (function sl__(t) {
        ...
        function _0x431caf(t) {
          for (
            var o = _0x3e45,
              ...
              u = window.location[o(386)],
              p = 0;
            p < n[o(389)];
            p++
          ) {
            var allowedDomain = n[p];
            // Special handling for localhost with any port
            if (allowedDomain === "localhost" && u.startsWith("localhost")) {
              continue; // Allow localhost with any port
            }
            if (u[o(370)](allowedDomain)) return void (e = !1);
          }
          // Special handling for 192.168.x.x IP addresses (local network testing)
          if (u.includes("192.168.")) {
            return void (e = !1); // Allow any 192.168.x.x IP
          }
        }
        function _0x582cb5(t) {
          for (
            ...
            if (u[o(379)](allowedDomain)) return void (e = !1);
          }
          // Special handling for 192.168.x.x IP addresses (local network testing)
          if (u.includes("192.168.")) {
            return void (e = !1); // Allow any 192.168.x.x IP
        ...
        var n = [o(387), o(397), o(398)],
          u = [
            "aHlwYWNrZWwuY29t",
            "ZDNydHp6enNpdTdnZHIuY2xvdWRmcm9udC5uZXQ=",
            "bG9jYWxob3N0",
...
(Savefile.resetOnLoad = 0),
  ...
  (Savefile.load = function () {
    if (
      ...
      for (var e in Savefile.data)
        e in Savefile.storeOb
          ? (Savefile.data[e] = Savefile.storeOb[e])
  ...
  (Savefile.set = function (e, a) {
    (e = Savefile.nameFile + e) in Savefile.data
      ? (Savefile.data[e] = a)
      : (Savefile.addKey(e, a),
        console.log(
  ...
  (Savefile.getCookie = function (e) {
    for (
      var a = e + "=", i = document.cookie.split(";"), t = 0;
      t < i.length;
      t++
    ) {
  ...
  (Blinker.prototype.update = function (t) {
    this.stopped ||
      (this._delay > 0
        ? (this._delay -= t)
        : (1 == this.state
            ? ((this.opacity += t * this.blinkSpeed),
              this.opacity > this.targetOpacity &&
                ((this.opacity = this.targetOpacity),
                this.loop ? (this.state = 2) : (this.stopped = !0)))
            : 2 == this.state &&
              ((this.opacity -= t * this.blinkSpeed),
              this.opacity < this.startOpacity &&
                ((this.state = 1),
...
FullscreenImage.attributes.add("stretch", { type: "boolean", default: !0 }),
  ...
  (FullscreenImage.prototype.updateSize = function () {
    ...
    this.stretch
      ? ((this.entity.element.width = pc.math.lerp(e.x, (n / i) * e.y, t)),
        (this.entity.element.height = pc.math.lerp((e.x * i) / n, e.y, t)))
      : n / i > this.nullRes.x / this.nullRes.y
      ? ((this.entity.element.width = pc.math.lerp(e.x, (n / i) * e.y, t)),
        (this.entity.element.height =
          (this.entity.element.width * this.nullRes.y) / this.nullRes.x))
      : ((this.entity.element.height = pc.math.lerp((e.x * i) / n, e.y, t)),
        (this.entity.element.width =
          (this.entity.element.height * this.nullRes.x) / this.nullRes.y));
  });
...
(Game.tempPos = new pc.Vec3()),
  ...
  (Game.prototype.initialize = function () {
    for (
      Game.instance = this,
        ...
        this.streak = 0,
        this.streakTimer = 0,
        pc.Application.getApplication().scene.layers.getLayerByName(
          "UIWorld"
        ).clearDepthBuffer = !0,
      ...
      (l = this.app.root.findByName("Level" + e.toString())),
        l
          ? (l.tags.add("level"), (l.enabled = !1), this.levels.push(l))
      ...
      setTimeout(function () {
        FadeScreen.instance.show(0.5, 3, !0, function () {
          (Game.instance.uiSplash.enabled = !1),
            (Input.mouseDis = !1),
            1 == Game.instance.currLevel &&
              0 == Game.levelDebug &&
              ((Game.instance.interface.enabled = !1),
              (Game.instance.mainMenu.enabled = !1)),
            (Game.instance.shop.enabled = !1),
            Game.levelDebug
              ? Game.instance.prepareQuick(
                  Game.instance._LEVEL_NUMBER,
                  Game.instance._BONUS_LEVEL
                )
              : Game.instance.prepareLevel(!1),
  ...
  (Game.prototype.saveGame = function () {
    ...
    for (var e = 0; e < ShopController.shopItems.length; e++)
      ShopController.shopItems[e].unlocked
        ? Savefile.set("skin" + e.toString(), 1)
        : Savefile.set("skin" + e.toString(), 0);
    Savefile.save();
  }),
  (Game.prototype.applyChosenSkin = function () {
    Knife.instance.trail1.flushTrail(), Knife.instance.trail2.flushTrail();
    var e = EntityTools.enableSingleInArray(
      Game.instance.knives,
  ...
  (Game.prototype.addMoney = function (e, t = !1) {
    (this.moneyEarned += e),
      ...
      UiInterface.instance &&
        ((UiInterface.instance.score.script.counterText.targetValue =
          this.score),
  ...
  (Game.prototype.loadLevel = function () {
    ...
    for (var a = 0; a < this.finish.children.length; a++)
      (t = this.finish.children[a]).script &&
        t.script.collBox &&
        t.script.collBox.init();
    ...
    for (var t, a, n = this.levelObjectsE.children.length - 1; n >= 0; n--)
      if ((t = this.levelObjectsE.children[n]).enabled)
        for (var s = t.children.length - 1; s >= 0; s--)
          (a = t.children[s]).enabled &&
            (("Molot" != a.name &&
              "SpikeMoving" != a.name &&
              "Spike" != a.name) ||
              (a.getPosition().distance(e) < 8 && a.destroy()));
  }),
  ...
  (Game.prototype.addLevel = function (e) {
    ...
    var l,
      ...
      r = o.getPosition();
    if ((t.removeChild(o), 0 == this.addedLevelsCount))
      Knife.instance.revive(),
        Game.KNIFE_NOT_SET_POS_ON_RESTART ||
          (r
            ? ((r.y += 1.35),
              (r.z = 0),
              (r.x -= 0.55),
              Knife.instance.entity.setPosition(r))
      ...
      for (var h, c, d = 0; d < t.children.length; d++)
        if ((h = t.children[d]).enabled && "Ground" == h.name) {
          var m = h.getPosition();
          (c = m.y + h.getLocalScale().y / 2) > this.levelUpperPlank &&
            (this.levelUpperPlank = c),
            Math.abs(m.x - r.x) < 0.8 && (h.enabled = !1);
        }
    ...
    for (d = 0; d < t.children.length; d++) {
      (h = t.children[d]).script &&
        h.script.physScaler &&
        h.script.physScaler.init();
      for (p = 0; p < h.children.length; p++)
        (l = h.children[p]).script &&
          l.script.sliceable &&
          l.script.physScaler &&
          l.script.physScaler.init();
    }
    for (d = 0; d < t.children.length; d++)
      (h = t.children[d]).script &&
        h.script.stackCreator &&
        h.script.stackCreator.init();
  ...
  (Game.prototype.kickSliceablesOnPos = function (e, t, a) {
    for (var n, s, i, l = 0; l < this.levelObjectsE.children.length; l++) {
      ...
      for (var o = 0; o < i.children.length; o++)
        (n = i.children[o]).enabled &&
          n.script &&
          n.script.sliceable &&
          ((s = n.script.polygon),
          Math.abs(s.pos.x - e.x) < t &&
            Math.abs(s.pos.y - e.y) < a &&
            n.script.sliceable.kick(e));
    }
  }),
    ...
    (t.distance = 12),
      ...
      FadeScreen.instance.show(0.3, 1, 0, function () {
        Game.instance.currLevel > 0
          ? (GameAudio.play("gameover"), (Game.instance.uiFailed.enabled = !0))
          : Game.instance.restart();
      });
  }),
  ...
  (Game.prepareLevels = function () {
    ...
    for (e = 0; e < Game.highLevelIds.length; e++)
      Game.normalLevelIds.splice(
        Game.normalLevelIds.indexOf(Game.highLevelIds[e]),
        1
      );
    for (e = 0; e < Game.excludeLevelIds.length; e++)
      Game.normalLevelIds.indexOf(Game.excludeLevelIds[e]) >= 0 &&
        Game.normalLevelIds.splice(
          Game.normalLevelIds.indexOf(Game.excludeLevelIds[e]),
          1
        );
  }),
  Game.prepareLevels(),
  (Game.prototype.prepareQuick = function (e, t) {
    (Game.bonusLevel = t),
      Game.bonusLevel
        ? (Game.bonusIds = [e])
        : ((Game.levelIdsPrev = [...Game.levelIds]), (Game.levelIds = [e]));
  }),
  (Game.prototype.prepareLevel = function (e) {
    (Game.bonusLevel = e),
      Game.bonusLevel
        ? (Game.bonusIds = [])
        : ((Game.levelIdsPrev = [...Game.levelIds]), (Game.levelIds = []));
    var t,
      a = 1,
      n = !1,
      s = !1;
    ...
    this.currLevel <= 3
      ? ((n = !0), (a = 1), (s = !1))
      : (this.currLevel >= 8 && Math.random() > 0.8 && (a = 2),
        this.currLevel >= 4 && Math.random() > 0.8 && (s = !0)),
      e && (a = 1);
    for (var i = 0; i < a; i++)
      e
  ...
  (Game.prototype.onLevelCompleted = function (e) {
    ...
    (Game.state = Game.STATE_LEVELCOMPLETED),
      ...
      this.stepsToBonusLevel <= 0 &&
        ((this.bonusReady = !0), (this.stepsToBonusLevel = 5)),
      (Game.goBonus = e),
      null != Game.instance.bonusOperator
        ? ((Game.instance.bonusEarned =
            FinishController.instance.applyOperatorData(
              Game.instance.moneyEarned,
              Game.instance.bonusOperator
            )),
          Game.instance.bonusOperator.operator == OperatorType.ADD ||
          Game.instance.bonusOperator.operator == OperatorType.MULTIPLY
            ? (this.resultType = 0)
            : Game.instance.bonusEarned < Game.instance.moneyEarned &&
              (this.resultType = 1))
  ...
  (Game.prototype.setupPlayingCamera = function (e) {
    ...
    a.camShift.set(1.2, -1, 0),
      ...
      (a.lerpAngle = 1),
      e &&
        (a.currPos.set(t.x - 5, t.y + 3, 10),
        a.entity.setLocalPosition(a.currPos));
  }),
  (Game.prototype.onJump = function () {
    Knife.instance.entity.getPosition();
    (GameAudio.playEx("swoosh", 1 + pc.math.random(-0.1, 0.1)),
    this.firstJump) &&
      ((Game.state = Game.STATE_PLAYING),
      (this.firstJump = !1),
      Game.bonusLevel || ((this.moneyEarned = 0), (this.score = 0)),
  ...
  (Game.prototype.onKnifeSlice = function (e) {
    ...
    t || (t = "slice2"),
      GameAudio.playEx(t, 1 + this.streak / 150 + pc.math.random(-0.1, 0.1));
  }),
  (Game.prototype.updateStreak = function (e) {
    if (
      this.streakTimer > 0 &&
      ((this.streakTimer -= e), this.streakTimer <= 0)
    ) {
      if (this.streak > 18) {
        var t,
          a = this.whiteColor;
        this.streak > 50
          ? ((a = this.yellowColor),
            (t = MathUtil.choose("INCREDIBLE!", "TERRIFIC!", "FANTASTIC!")))
          : (t =
              this.streak > 25
                ? MathUtil.choose("AMAZING!", "AWESOME!", "WOW!")
                : MathUtil.choose("NICE!", "GREAT!", "EXCELLENT!")),
  ...
  (Game.prototype.addIfLevelExists = function (e) {
    ...
    return (
      !!t ||
      (!!(t = this.app.root.findByName("Level" + e.toString())) &&
        (t.tags.add("level"), (t.enabled = !1), (this.levels[e] = t), !0))
    );
  }),
  ...
  (Game.prototype.setResolution3 = function () {
    ...
    e < 640 &&
      (this.app.setCanvasResolution(pc.RESOLUTION_AUTO, e, t),
  ...
  (Game.prototype.setResolution = function () {
    var e = window.innerWidth,
      t = window.innerHeight;
    this.hdEnabled
      ? this.app.setCanvasResolution(pc.RESOLUTION_FIXED, (e / t) * 1080, 1080)
      : (this.app.setCanvasResolution(pc.RESOLUTION_AUTO, e, t),
  ...
  (Game.prototype.restart = function (e) {
    ...
    Game.bonusLevel
      ? (Environment.instance.setType(6),
        (this.interface.enabled = !0),
        (this.mainMenu.enabled = !1))
      : (this.currLevel != this.lastCurrLevel &&
          ((this.lastCurrLevel = this.currLevel),
          Sdkmanager.instance.launchSDKfunction(
            Sdkmanager.SDK_COOLMATH,
            "startLevel",
            Game.instance.currLevel
          )),
        (this.moneyEarned = 0),
        (this.score = 0),
        this.envTypeSameCount >= 4
          ? (Environment.instance.switchType(),
    ...
    e)
      ? UiMainMenu.hideCap &&
        (this.levText && (this.levText.destroy(), (this.levText = null)),
        (this.levText = this.showLvlText(
          "LEVEL " + this.currLevel.toString(),
          t.x + 4.5,
          t.y + 1
        )))
  ...
  (Game.prototype.update = function (e) {
    if (
      ...
      CameraController.instance.yaw = pc.math.lerp(
        -42,
        -16,
        pc.math.clamp((t - a) / a, 0, 1)
      );
    }
    Game.noDebug ||
      ...
      this.app.keyboard.wasPressed(pc.KEY_S) &&
    ...
    switch (e) {
      ...
      case "ShopMoneyForReward":
        Sdkmanager.instance.showAd(
          [Sdkmanager.SDK_TESTING, Sdkmanager.SDK_COOLMATH],
          Sdkmanager.AD_REWARDED,
          () => {
            FadeScreen.instance.show(0.4, 0, !0, function () {
              (Game.instance.shopRewardCooldownCurr =
                Game.instance.shopRewardCooldown),
      ...
      case "contactbh5":
        window.open(
          "mailto:contact@buyhtml5.com?subject='Slice Master' Licensing"
        );
        break;
      case "failRestart":
        Sdkmanager.instance.launchSDKfunction(
      ...
      case "buyBut":
        (s = a.shopItem),
          Game.instance.addStars(-s.price) &&
      ...
      case "resume":
        setTimeout(function () {
          Uipopup.getState("Pause") == Uipopup.STATE_CLOSED &&
      ...
      case "closeTutor":
        MyButton.setClickable(Game.instance.gameOver, !0),
          ...
          Game.instance.state == Game.STATE_PLAYING
            ? Uipopup.open("Pause", !0)
            : Uipopup.open("Settings", !0);
        break;
      case "openSettings":
      ...
      case "closeSettings":
        MyButton.setClickable(Game.instance.gameOver, !0),
          ...
          setTimeout(function () {
            Game.instance.mainMenu.enabled &&
              (Game.instance.controlsEnabled = !0);
          }, 500);
        break;
      case "pauseContinue":
...
(Knife.tempVec = new pc.Vec3()),
  ...
  (Knife.prototype.kill = function (t) {
    ...
    (this.dead = !0),
      ...
      (this.physModel.rigidbody.angularVelocity = new pc.Vec3(
        0,
        0,
        (this.rotVel / 180) * 3.14
      )),
  ...
  (Knife.prototype.checkGroundCol = function () {
    if (!this.dead) {
      Environment.instance && 6 == Environment.instance.type && 0,
        (this.bladeC.checkIfUnderLine(-1) || this.bodyC.checkIfUnderLine(-1)) &&
          this.kill("ground");
    }
  }),
  ...
  (Knife.prototype.onBodyTriggerEnter = function (t) {
    ...
    if (!this.dead && t.entity.tags.has("deadzone"))
      return this.kill("falled"), 1;
    if (
      (t.findContact(this.bodyC),
    ...
    if (
      ...
      Knife.tempVec.copy(Polygon.contactNormal),
        Knife.tempVec.mulScalar(0.5 * -Polygon.contactDepth),
        Knife.tempVec.add(t.entity.getPosition()),
        (i.kickCd = 0.1);
      var o = t.entity.rigidbody;
      o &&
        1 == this.state &&
        (t.pos.x > this.bladeC.pos.x
          ? o.applyImpulse(0.5 * -this.vel.x, 0.5 * -this.vel.y, 0)
          : o.applyImpulse(0.1 * -this.vel.x, 0.1 * -this.vel.y, 0));
    }
    1 == this.state
      ? (this.bounceCd = 0.05)
      : 0 != this.state ||
  ...
  (Knife.prototype.onBladeTriggerEnter = function (t) {
    ...
    if (e.tags.has("ground") && 1 == this.state) {
      if (
        (t.findContact(this.bladeC),
        Knife.tempVec.copy(Polygon.contactNormal),
        Knife.tempVec.mulScalar(0.5 * Polygon.contactDepth - 0.05),
        this.entity.translate(Knife.tempVec),
        this.stuck(),
        "kinematic" == e.rigidbody.type &&
          (this.groundStartPos.copy(t.pos),
          this.groundKnifePosStart.copy(this.entity.getPosition()),
          (this.ground = t)),
        e.tags.has("finish"))
      ) {
        Game.instance.bonusOperator =
          FinishController.instance.getBlockOperator(e);
        var i = FinishController.instance.getBlockData(e),
          s = !1;
        Game.instance.bonusOperator
          ? 50 == i.count && Game.instance.bonusReady
            ? (GameAudio.play("bonushit"), (s = !0))
            : GameAudio.play("xhit")
    ...
    if (e.tags.has("sliceable")) {
      ...
      var a = 0;
      o.complexSlice && (a = (this.bladeC.pos.z - t.pos.z) / t.zSize + 0.5),
        o.slice(a),
        (this.sliceCd = 0.1),
        this.vel.x > 0 &&
          ((this.vel.x -= 0.5), this.vel.x < 0 && (this.vel.x = 0));
    }
    if (e.tags.has("spike")) {
      for (var l = 0; l < 8; l++)
        EffectDrop.create(
  ...
  (Knife.prototype.update = function (t) {
    ...
    if (this.jumpCd > 0) this.jumpCd -= t;
      ...
      Game.instance.controlsEnabled &&
      ((Input.mousePressed && e > 0.1 && Game.state == Game.STATE_PLAYING) ||
        (Input.mousePressed &&
          e > 0.1 &&
          Input.mouseX > 140 &&
          Game.state == Game.STATE_INTRO) ||
        (this.app.keyboard.wasPressed(pc.KEY_SPACE) &&
          (Game.state == Game.STATE_INTRO || Game.state == Game.STATE_PLAYING)))
    ) {
      (this.jumpCd = 0.15),
      ...
      this.bodyC.pos.y > Game.instance.levelUpperPlank && (i.y = 1),
        ...
        (this.dampCd = 0.45),
        0 == this.state ? (this.stuckCd = 0.4) : (this.stuckCd = 0.15),
        (this.bounceCd = 0),
        this.unstuck(),
    ...
    for (var s = 0.2 * t, n = 0; n < 5; n++) {
      if (1 == this.state) {
        ...
        this.rotVel < -Knife.ROT_VEL_MAX && (this.rotVel = -Knife.ROT_VEL_MAX),
          ...
          l < 0
            ? (this.rotVel = pc.math.lerp(
                this.rotVel,
                -Knife.ROT_VEL_MAX,
                10 * s
              ))
            : this.dampCd <= 0 &&
              (this.rotVel = pc.math.lerp(this.rotVel, -85, 17 * s)),
          this.dampCd <= 0 &&
            this.sliceCd > 0 &&
            o.z + 180 > 300 &&
            a < 60 &&
            ((o.z += MathUtil.angleDifference(o.z, 170) * s * 11),
      ...
      Knife.tempVec.copy(this.vel),
        ...
        Knife.tempVec.y > Game.instance.levelUpperPlank &&
          (Knife.tempVec.y = pc.math.lerp(
            Knife.tempVec.y,
            Game.instance.levelUpperPlank,
            0.25
          )),
    ...
    Game.state == Game.STATE_PLAYING &&
      1 == this.state &&
      (Math.abs(this.bodyC.pos.y - Game.instance.levelUpperPlank) > 3
        ? (UiInterface.instance.highFlyTime = 0)
        : (UiInterface.instance.highFlyTime += t),
      this.bodyC.pos.y > Game.instance.levelUpperPlank &&
        this.vel.y > 0 &&
        (this.vel.y = pc.math.lerp(this.vel.y, 0, 10 * t)),
      this.checkGroundCol());
  });
...
(CameraController.instance = null),
  ...
  (CameraController.prototype.update = function (t) {
    ...
    (this.pitchCurr = pc.math.lerp(e.x, this.pitch, (t * this.lerpAngle) / 1)),
      ...
      (this.distanceCurr = pc.math.lerp(
        this.distanceCurr,
        this.distance,
        t * this.lerpAngle
      )),
...
Polygon.attributes.add("points", {
  ...
  (Polygon.initPolygonsOnEntity = function (o, t) {
    var i;
    if (
      (o.script && o.script.polygon && o.script.polygon.init(), t) &&
      o.children
    )
      for (var n = 0; n < o.children.length; n++)
        (i = o.children[n]), Polygon.initPolygonsOnEntity(i, t);
  }),
  ...
  (Polygon.prototype.init = function () {
    if (
      ...
      if (this.polyFromCollisionBox) {
        ...
        var s = 1 / n.x;
        "cylinder" == i.type
          ? (this.addLocalPoint(-i.radius * s, (0.5 * i.height) / n.y),
            this.addLocalPoint(i.radius * s, (0.5 * i.height) / n.y),
            this.addLocalPoint(i.radius * s, (0.5 * -i.height) / n.y),
            this.addLocalPoint(-i.radius * s, (0.5 * -i.height) / n.y))
          : (this.entity.script &&
              this.entity.script.sliceable &&
              this.entity.script.sliceable.complexSlice &&
              (this.zSize = 2 * t.z),
  ...
  (Polygon.prototype.updateBoundRadius = function () {
    if (this.type == Polygon.TYPE_CIRC)
      return (this.boundRadius = this.radius), 0;
    ...
    for (var t, i, n = 0; n < Polygon.polygons.length; n++)
      if (
        ...
        if (t.zSize <= 0) {
          ...
          this.pos.z < t.pos.z - 0.5 * t.zSize ||
          this.pos.z > t.pos.z + 0.5 * t.zSize
        )
          continue;
        (i =
          (this.boundRadius + t.boundRadius) *
          (this.boundRadius + t.boundRadius)),
          Polygon.tempVec.copy(t.pos),
          Polygon.tempVec.sub(this.pos),
          Polygon.tempVec.lengthSq() >= i ||
            (this.checkCollision(t) &&
              this.entity.fire("polygon:collision", t));
      }
  }),
  ...
  (Polygon.prototype.updatePoints = function () {
    for (
      var o = this.entity.getWorldTransform(), t = 0;
      t < this.pps.length;
      t++
    )
      o.transformPoint(this.lps[t], this.pps[t]), (this.pps[t].z = 0);
  }),
  ...
  (Polygon.prototype.addLocalPoint = function (o, t) {
    ...
    this.entity.addChild(i),
      ...
      Polygon.DRAW_DOTS && i.addComponent("render", { type: "sphere" }),
      i.setLocalScale(0.1, 0.1, 0.1),
      this.points.push(i);
  }),
      ...
      for (var y = 0; y < l; y++) {
        ...
        for (var a = 0; a < p; a++)
          (e = o.pps[a]),
            ...
            (t =
              this.ns[y].x * Polygon.tempVec.x +
              this.ns[y].y * Polygon.tempVec.y) > 0 ||
              (((t = -t) > i || null == i) && (i = t));
        (n > i || null == n) && ((n = i), (s = y));
      }
      return (
        (Polygon.contactDepth = n),
  ...
  (Polygon.pointPolyCollision = function (o, t) {
    for (
      var i, n, s = t.pps.length, e = 0, l = s - 1, p = o.x, y = o.y, a = !1;
      e < s;
      l = e++
    )
      (i = t.pps[e]),
  ...
  (Polygon.pointLineSegmentDistance = function (o, t, i) {
    var n,
      ...
      l = i;
    return Math.sqrt(
      Polygon.pointPointSquaredDistance(
        o,
        (n = Polygon.pointPointSquaredDistance(e, l))
          ? (s = ((o.x - t.x) * (l.x - t.x) + (o.y - t.y) * (l.y - e.y)) / n) <
            0
            ? t
            : s > 1
            ? l
            : new pc.Vec3(t.x + s * (l.x - t.x), t.y + s * (l.y - t.y), 0)
          : e
      )
    );
  }),
  (Polygon.pointLineSegmentDistance2 = function (o, t, i) {
    var n,
      ...
      l = i;
    return (
      Polygon.pointPointSquaredDistance(e, l),
      Math.sqrt(
        pointPointSquaredDistance(
          o,
          (n = Polygon.pointPointSquaredDistance(e, l))
            ? (s =
                ((o.x - t.x) * (l.x - t.x) + (o.y - t.y) * (l.y - e.y)) / n) < 0
              ? t
              : s > 1
              ? l
              : new pc.Vec3(t.x + s * (l.x - t.x), t.y + s * (l.y - t.y), 0)
    ...
    for (e = 0; e < 2; e++) {
      ...
      for (h = g.length, l = 0; l < h; l++) {
        var d = (l + 1) % h,
          ...
          m = Polygon.tempVec;
        for (
          m.set(f.y - u.y, u.x - f.x), i = n = void 0, p = 0;
          p < r.length;
          p++
        )
          (s = m.x * r[p].x + m.y * r[p].y),
            (null == i || s < i) && (i = s),
            (null == n || s > n) && (n = s);
        for (y = a = void 0, p = 0; p < c.length; p++)
  ...
  (Polygon.prototype.checkCollision = function (o) {
    return o.type == Polygon.TYPE_POLY && this.type == Polygon.TYPE_POLY
      ? Polygon.polyPolyCollision(this, o)
      : o.type == Polygon.TYPE_CIRC && this.type == Polygon.TYPE_POLY
      ? Polygon.polyCircCollision(this, o)
      : o.type == Polygon.TYPE_POLY && this.type == Polygon.TYPE_CIRC
      ? Polygon.polyCircCollision(o, this)
      : void 0;
  });
...
PolygonTest.attributes.add("poly2", { type: "entity" }),
  ...
  (PolygonTest.prototype.update = function (t) {
    this.app.keyboard.wasPressed(pc.KEY_A) &&
      ...
      this.p1.checkCollision(this.p2) &&
        (console.log("push out"), this.p2.pushOut(this.p1, this.p1.entity)));
  });
...
Sliceable.attributes.add("left", { type: "entity" }),
  ...
  (Sliceable.prototype.initialize = function () {
    if (
      ((this.kickCd = 0),
      (this.kick2Cd = 0),
      ("CubeComplex" != this.entity.name &&
        "Tube" != this.entity.name &&
        "TubeVert" != this.entity.name &&
        "Cube" != this.entity.name &&
        "RoundCube" != this.entity.name) ||
      ...
      this.complexSlice
        ? (t.linearFactor = new pc.Vec3(1, 1, 1))
        : (t.linearFactor = new pc.Vec3(1, 1, 0)),
        (t.angularFactor = new pc.Vec3(0, 0, 1));
    }
    if (
      (this.static && (this.entity.rigidbody.type = "static"),
      this.staticOneSide &&
      ...
      this.matVnutri &&
        this.matVnutri != this.innerMat &&
        this.innerMat &&
        (EntityTools.changeMaterial(
          this.left.children[0],
          this.innerMat,
          this.matVnutri
        ),
        EntityTools.changeMaterial(
          this.right.children[0],
          this.innerMat,
          this.matVnutri
        )),
  ...
  (Sliceable.prototype.changeBaseMat = function (t) {
    (this.mat = t),
      ...
      this.left &&
        EntityTools.changeMaterial(this.left.children[0], this.baseMat, t),
      this.right &&
        EntityTools.changeMaterial(this.right.children[0], this.baseMat, t);
  }),
  ...
  (Sliceable.prototype.kick = function (t, e) {
    ...
    this.static &&
      ...
      (this.static = !1),
      (i.type = "dynamic"),
      this.entity.script.polygon.pos.z < t.z
        ? (i.applyTorque(55, 0, 0), i.applyImpulse(0, 0, -0.1))
        : (i.applyTorque(-55, 0, 0), i.applyImpulse(0, 0, 0.1)),
  ...
  (Sliceable.prototype.slice = function (t) {
    ...
    this.left &&
      ...
      this.right &&
        ...
        s.applyTorque(45, 0, 0));
    var l,
      r = this.entity.getPosition(),
      n = "+" + this.price.toString(),
      c = 0.8;
    if (
      (this.price > 10
        ? ((l = Game.instance.yellowColor), (c = 1.2))
        : this.price >= 5
        ? ((l = Game.instance.greenColor), (c = 1))
        : ((l = Game.instance.whiteColor), (c = 0.8)),
      (l = Game.bonusLevel
        ? Game.instance.yellowColor
        : Game.instance.whiteColor),
      Game.instance.showText(n, r.x, r.y, l, 1, c),
      Game.instance.addMoney(this.price, !0),
      this.emitId >= 0 && this.emitCount > 0)
    ) {
      this.emitColorFromDiffuse &&
        (this.mat
          ? (this.emitColor = this.mat.resource.diffuse)
          : this.baseMat && (this.emitColor = this.baseMat.resource.diffuse));
      for (var h = 0; h < this.emitCount; h++)
        this.emitRadius > 0
          ? (Sliceable.temp.copy(r),
            (Sliceable.temp.x += pc.math.random(
              -this.emitRadius,
              this.emitRadius
            )),
            (Sliceable.temp.y += pc.math.random(
              -this.emitRadius,
              this.emitRadius
            )),
            (Sliceable.temp.z += pc.math.random(
              -this.emitRadius,
              this.emitRadius
            )),
            Sliceable.temp2.set(
            ...
            EffectDrop.create(
              Sliceable.temp,
              pc.math.random(0.3, 0.5) + 0.25 * this.emitRadius,
              Sliceable.temp2,
              this.emitId,
              this.emitColor
            ))
  ...
  (StackCreator.prototype.init = function () {
    for (
      var t,
        ...
        r = new pc.Vec3(),
        n = 1,
        s = this.entity.getLocalEulerAngles(),
        o = 0,
        c = 1,
        d = this.count - 1;
      d >= 0;
      ...
      d > 0
        ? (t = this.entity.clone()).script.destroy("stackCreator")
        : (t = this.entity),
        (e = t.script.sliceable),
        this.static &&
          ((t.rigidbody.type = "static"), (t.script.polygon.static = !0)),
        this.staticOneSide &&
          ((e.left.rigidbody.type = "static"), (r.z = -0.04)),
        e.baseMat &&
          this.mats.length > 0 &&
          ((e.mat = this.mats[o]),
          ...
          this.mats.length > 1 &&
            ((o += c),
            c > 0 && o >= this.mats.length - 1
              ? ((o = this.mats.length - 1), (c = -1))
              : c < 0 && o <= 0 && ((o = 0), (c = 1)))),
        this.multicolorVnutri &&
          ((e.matVnutri = StackCreator.getStackColor()),
          0 == d &&
            (EntityTools.changeMaterial(
              e.left.children[0],
              e.innerMat,
        ...
        this.isFigure &&
          ((a = t.getLocalScale()),
          (n = 0.75 + 0.25 * Math.cos((3.14 * d) / 10)),
          t.setLocalScale(a.x, a.y, a.z * n)),
        r.copy(i),
        this.sideStack
          ? (r.x += d * this.yDistance)
          : (r.y += d * this.yDistance),
        0 != this.zRandom &&
          (r.z += pc.math.random(-this.zRandom, this.zRandom)),
        this.yRandomAngle > 0 &&
          ((t.rigidbody.angularFactor = new pc.Vec3(0, 1, 1)),
          t.setLocalEulerAngles(
            s.x,
            s.y + pc.math.random(-this.yRandomAngle, this.yRandomAngle),
            s.z
          )),
        d > 0 &&
          (this.entity.parent.addChild(t),
          t.rigidbody ? t.rigidbody.teleport(r) : t.setPosition(r));
  }),
  (StackCreator.getStackColor = function () {
    return (
      Sliceable.innerMatId++,
      Sliceable.innerMatId >= Game.instance.innerMat.length &&
        (Sliceable.innerMatId = 0),
...
(Effect3ddrop.grav = new pc.Vec3(0, -15, 0)),
  ...
  (Effect3ddrop.create = function (t, e) {
    ...
    return (
      (i.render.meshInstances[0].material = e),
...
PhysScaler.attributes.add("initialScale", { type: "vec3", default: [0, 0, 0] }),
  ...
  (PhysScaler.prototype.init = function () {
    ...
    var t = Math.max(
        PhysScaler.tempVec.x,
        PhysScaler.tempVec.y,
        PhysScaler.tempVec.z
      ),
      i = this.entity.collision;
    i &&
      ("box" == i.type
        ? (PhysScaler.tempVec.mul(this.initialHalfExtents),
          (i.halfExtents = PhysScaler.tempVec.clone()))
        : "sphere" == i.type
        ? (i.radius = t * this.initialRadius)
        : "cylinder" == i.type &&
          ((i.radius = PhysScaler.tempVec.x * this.initialRadius),
...
GameText.attributes.add("glow", { type: "entity" }),
  ...
  (GameText.prototype.update = function (t) {
    ...
    (this.time += t),
      1 == this.state &&
        ((e = this.time / this.appearTime) >= 1 &&
          ((e = 1), (this.state = 2), (this.time = 0)),
        2 == this.hideAnimType
          ? (this.entity.translateLocal(0, -500 * t, 0),
            (this.entity.element.opacity = e),
            (e = this.scaleMax),
            this.entity.setLocalScale(e, e, e))
          : ((e *= this.scaleMax), this.entity.setLocalScale(e, e, e))),
      2 == this.state &&
        ((e = this.time / this.showTime) >= 1 &&
          ((e = 1), (this.state = 3), (this.time = 0)),
        1 == this.hideAnimType
          ? this.entity.translateLocal(0, 50 * t, 0)
          : ((e = this.scaleMax + 0.1 * e),
            this.entity.setLocalScale(e, e, e),
            this.entity.translateLocal(0, -50 * t, 0))),
      3 == this.state &&
        ((e = 1 - this.time / this.hideTime) <= 0 &&
          ((e = 0), ObjectPool.push(this.entity)),
        1 == this.hideAnimType
          ? ((this.entity.element.opacity = e),
            this.entity.translateLocal(0, 400 * t, 0))
          : (this.entity.element.opacity = e));
  });
...
FinishController.attributes.add("blocks", { type: "entity", array: !0 }),
  ...
  (FinishController.prototype.setBestBlockType = function () {
    for (
      var t, o, e = 0;
      e < FinishController.blockData.length &&
      50 != (t = FinishController.blockData[e]).count;
      e++
    );
    var r,
      l,
      n = FinishController.blockData[0].blockType,
    ...
    for (e = 1; e < FinishController.blockData.length; e++)
      (l = FinishController.blockData[e].blockType),
        (r = this.applyOperatorData(100, l)) > a &&
          ((a = r), (n = l), (o = FinishController.blockData[e]));
  ...
  (FinishController.prototype.placeBlocks2 = function (t) {
    ...
    for (var n, a, i = 0, s = 0; s < this.blocks.length; s++) {
      ...
      for (var p = 0; p < FinishController.blockData.length; p++)
        2 == (o = FinishController.blockData[p]).count && o.entity,
          l == o.entity && ((o.blockType = this.blockTypes[i]), i++);
    }
    ...
    for (p = 0; p < FinishController.blockData.length; p++)
      (a = (o = FinishController.blockData[p]).blockType),
        ...
        (e.y += 0.5 * o.sizeY);
    t
      ? ((n.text.element.text = "BONUS!"), (n.text.script.scaler.enabled = !0))
      : ((n.text.script.scaler.enabled = !1),
        n.text.setLocalScale(0.01, 0.01, 0.01)),
      (e.y += 0.5 * this.lastBlockSizeY),
      this.lastBlock.setLocalPosition(e.x, e.y, e.z);
  });
var OperatorType = {
  ADD: { symbol: "+", maxCount: 500, minCount: 10 },
  SUBTRACT: { symbol: "-", maxCount: 100, minCount: 5 },
  MULTIPLY: { symbol: "x", maxCount: 10, minCount: 2 },
  DIVIDE: { symbol: "÷", maxCount: 10, minCount: 2 },
};
(FinishController.prototype.generateRandomBlockData = function () {
  (this.blockTypes = []),
    ...
    this.blockTypes.push(this.createBlock(OperatorType.ADD));
  var t,
    o = this.getRandomNegativeOperator();
  (t =
    Math.random() > 0.6
      ? (OperatorType.SUBTRACT, OperatorType.DIVIDE)
      : this.getRandomPositiveOperator()),
  ...
  (FinishController.prototype.beautifyNumber = function (t, o) {
    ...
    if (t < 5)
      ...
      e =
        o == OperatorType.ADD || o == OperatorType.SUBTRACT
          ? [5, 10][Math.floor(2 * Math.random())]
          : t;
    else if (t <= 100) {
  ...
  (FinishController.prototype.applyOperatorData = function (t, o) {
    var e = t;
    return (
      o.operator == OperatorType.MULTIPLY
        ? (e *= o.value)
        : o.operator == OperatorType.DIVIDE
        ? (e /= o.value)
        : o.operator == OperatorType.ADD
        ? (e += o.value)
        : o.operator == OperatorType.SUBTRACT && (e -= o.value),
      Math.round(e)
    );
  }),
  (FinishController.prototype.generateBlockText = function (t, o) {
    ...
    return (
      o == OperatorType.MULTIPLY
        ...
        : o == OperatorType.ADD
        ? (e = "+ " + t.toString())
        : o == OperatorType.SUBTRACT && (e = "- " + t.toString()),
      e
    );
  }),
  ...
  (FinishController.prototype.placeBlocks = function (t) {
    ...
    for (var n = 0; n < FinishController.blockData.length; n++)
      50 == (o = FinishController.blockData[n]).count && (l = o),
        ...
        (e.y += 0.5 * o.sizeY);
    t
      ? ((l.text.element.text = "BONUS!"), (l.text.script.scaler.enabled = !0))
      : ((l.text.element.text = "50 x"),
        (l.text.script.scaler.enabled = !1),
        l.text.setLocalScale(0.01, 0.01, 0.01)),
      (e.y += 0.5 * this.lastBlockSizeY),
      this.lastBlock.setLocalPosition(e.x, e.y, e.z);
  }),
  ...
  (FinishController.prototype.showFlag = function () {
    setTimeout(function () {
      ...
      for (
        var t = FinishController.instance.entity.getPosition(), o = 0;
        o < 59;
        o++
      )
        Serpantine.create(t);
      ...
      (this.flag.enabled = !0),
      this.flag
        .tween(this.flag.getLocalEulerAngles())
        .rotate({ x: 0, y: 0, z: 0 }, 0.75, pc.BounceOut)
        .loop(!1)
        .yoyo(!1)
        .start();
  });
...
(MaterialBlinker.prototype.initialize = function () {
  var i, t, s;
  (this.meshInstances = this.entity.model
  ...
  (MaterialBlinker.prototype.update = function (i) {
    ...
    (this.blinkAlpha += this.blinkSpeed * i),
      this.blinkSpeed > 0 && this.blinkAlpha >= this.blinkTarget
...
(Environment.instance = null),
  ...
  (Environment.prototype.createGrounds = function () {
    for (
      this.clearGrounds(), this.groundLastPos.set(-25, 0, 0);
      Game.instance.lastPos.x + 60 > this.groundLastPos.x;
      ...
      (n.enabled = !1),
        this.entity.addChild(t),
        t.setPosition(
          this.groundLastPos.x - e.x,
          this.groundLastPos.y - e.y,
          0
        ),
        (t.enabled = !0);
      var s = t.findByName("End"),
  ...
  (Environment.prototype.clearGrounds = function () {
    for (var t, n = this.groundsAr.length - 1; n >= 0; n--)
      (t = this.groundsAr[n]), this.entity.removeChild(t), t.destroy();
    this.groundsAr = [];
  }),
  ...
  (Environment.prototype.switchType = function () {
    ...
    this.envId++,
      this.envId >= this.envTypes.length &&
        ((this.envId = 0),
        MathUtil.shuffleArray(this.envTypes),
        (t = this.envTypes[this.envId]) == n &&
...
Jumper.attributes.add("delayStart", { type: "number", default: 0 }),
  ...
  (Jumper.prototype.update = function (t) {
    ...
    this._delay > 0 && (this._delay -= t),
      Jumper.tmp
        .copy(this._acc)
        .scale(t * this.jumpSpeed * Game.instance.slomo),
...
UiScore.attributes.add("score", { type: "entity" }),
  ...
  (UiScore.prototype.onEnable = function () {
    this.score.script.counterText.setValue(
      0,
      Game.instance.currScore,
      Game.instance.currScore
    );
  }),
...
ShopController.attributes.add("rewButton", { type: "entity" }),
    ...
    for (var e = 0, o = -250; o <= 250; o += 250)
      for (var n = -230; n <= 230; n += 230)
        (t = this.shopItem.clone()),
          ...
          (t.script.scaler.delay =
            0.08 * ShopController.shopItems[e].iconIndex),
  ...
  (ShopController.prototype.unlockRandomSkin = function () {
    for (var t = [], e = 0; e < ShopController.shopItems.length; e++)
      ShopController.shopItems[e].unlocked ||
        t.push(ShopController.shopItems[e].shopItem);
    if (0 == t.length) return 1;
    if (
      (1 == t.length && (this.unlockSteps = 1),
      ...
      for (e = 0; e < this.unlockSteps; e++)
        (o = MathUtil.getRandomInt(t.length - 1)) == n &&
          (o++, n > t.length - 1 && (o = 0)),
  ...
  (ShopController.prototype.updateRewardButton = function (t) {
    ...
    if (Game.instance.shopRewardCooldownCurr > 0) e = !1;
      ...
      o <= 0
        ? (e = !1)
        : ((!t && this.rewButton.enabled) ||
            this.rewButton.script.moneyForAdbutton.reconfigure(o),
          (e = !0));
    }
  ...
  (ShopController.prototype.update = function (t) {
    if (
      ...
      this.unlocking && ((this.unlockTimer -= t), this.unlockTimer < 0))
    ) {
      ...
      e.script.textScaler.start(!0),
        this.unlockSteps <= 0
          ? ((this.unlocking = !1),
            ...
            Game.instance.saveGame(),
            this.itemsAvailable()
              ? (this.allKnivesUnlockedMsg.enabled = !1)
              : (this.allKnivesUnlockedMsg.enabled = !0))
          : GameAudio.play("pop2");
    }
  }),
  ...
  (ShopController.prototype.showItem = function (t) {
    ...
    for (var e = 0; e < this.modelEntity.children.length; e++)
      e == t
        ? (this.modelEntity.children[e].enabled = !0)
        : (this.modelEntity.children[e].enabled = !1);
    var o = ShopController.shopItems[this.shownItemId];
    !0 === o.unlocked || 1 === o.unlocked
      ...
      : ((this.priceText.element.text = o.price.toString()),
        ...
        Game.instance.stars >= o.price
          ? ((this.unlock.enabled = !0), (this.buy2.enabled = !1))
          : ((this.unlock.enabled = !1), (this.buy2.enabled = !0))),
      this.updateArrows();
  }),
  ...
  (ShopController.prototype.itemsAvailable = function () {
    for (var t = 0; t < ShopController.shopItems.length; t++)
      if (
        !ShopController.shopItems[t].unlocked &&
        ShopController.shopItems[t].price <= Game.instance.money
      )
        return !0;
    return !1;
  }),
  ...
  (ShopController.prototype.buyItem = function (t) {
    ...
    !0 === e.unlocked ||
      1 === e.unlocked ||
      (Game.instance.wasteCoins(e.price) &&
...
(UiInterface.instance = null),
  ...
  (UiInterface.prototype.onEnable = function () {
    Game.instance.paused
      ? ((this.levText.enabled = !1), (this.bonText.enabled = !1))
      : Game.bonusLevel
      ? ((this.highFlyTime = 0),
        (this.levText.enabled = !1),
        (this.bonText.enabled = !0))
      : ((this.highFlyTime = 0),
        Game.lvlTextShown
          ? (this.levText.enabled = !1)
          : (this.levText.enabled = !0),
  ...
  (UiInterface.prototype.update = function (e) {
    (this.score.element.text = "$ " + Game.instance.score.toString()),
      this.highFlyTime > 1
        ? (this.arrowDown.enabled = !0)
        : (this.arrowDown.enabled = !1);
  });
    ...
    if (
      ...
      (e = Math.floor(e / 100)),
        (this.entity.element.text =
          e > 0
            ? Math.floor(this.count / 1e3).toString() + "." + e.toString() + "k"
            : Math.floor(this.count / 1e3).toString() + "k");
    } else this.entity.element.text = Math.round(this.count).toString();
  }),
  (CoinsText.moneyToText = function (t) {
    if (this.count >= 1e3) {
      var e = this.count % 1e3;
      (e = Math.floor(e / 100)) > 0
        ? Math.floor(t / 1e3).toString() + "." + e.toString() + "k"
        : Math.floor(t / 1e3).toString() + "k";
...
CounterText.attributes.add("targetValue", { type: "number", default: 0 }),
  ...
  (CounterText.prototype.updText = function () {
    ...
    "" != this.text &&
      (this.textBefore ? (t = this.text + t) : (t += this.text)),
    ...
    1 == this.state
      ? ((this.scale += t * this.scaleSpeed),
        this.scale > this.targetScale &&
          ((this.state = 2), (this.scale = this.targetScale)))
      : 2 == this.state &&
        ((this.scale -= t * this.scaleSpeed),
...
Rotator.attributes.add("speed", { type: "vec3" }),
  ...
  (Rotator.prototype.update = function (t) {
    ...
    Rotator.tmp.copy(this.speedCurr),
      ...
      this.minMax &&
        (e.z <= this.minAng.z
          ? ((e.z = this.minAng.z), (this.speedCurr.z = Math.abs(this.speed.z)))
          : e.z >= this.maxAng.z &&
            ((e.z = this.maxAng.z),
            (this.speedCurr.z = -Math.abs(this.speed.z)))),
      this.entity.element
        ? this.entity.setLocalEulerAngles(e)
        : this.entity.rotateLocal(
            this.speedCurr.x * t,
            this.speedCurr.y * t,
            this.speedCurr.z * t
...
(ShopItem.prototype.initialize = function () {
  ...
  (ShopItem.prototype.updateState = function () {
    ...
    t.unlocked
      ...
      t.itemId == Game.instance.chosenSkinId
        ? (this.hl.enabled = !0)
        : (this.hl.enabled = !1);
  });
...
(EffectDrop.grav = new pc.Vec3(0, -19, 0)),
  ...
  (EffectDrop.prototype.update = function (t) {
    if (
      ...
      (this.size -= 0.5 * t * Game.instance.slomo),
      this.size <= 0)
    )
      ObjectPool.push(this.entity);
    else {
  ...
  (Molot.prototype.initialize = function () {
    this.entity.setLocalEulerAngles(90, 0, 0),
      this.entity
        ...
        .rotate(new pc.Vec3(-90, 0, 0), this.time, pc.QuadraticInOut)
        .loop(!0)
        .yoyo(!0)
        .delay(this.delay)
        .start();
...
(CurrLevelText.prototype.initialize = function () {
  ...
  (CurrLevelText.prototype.onEnable = function () {
    Game.levelDebug
      ? (this.entity.element.text =
          "level " + Game.instance._LEVEL_NUMBER.toString())
      : (this.entity.element.text =
          "level " + Game.instance.currLevel.toString());
  }),
...
UiCompleted.attributes.add("textColors", { type: "rgba", array: !0 }),
  ...
  (UiCompleted.prototype.onEnableCb = function () {
    ...
    (this.counterTimer = 0),
      ...
      Game.instance.totalEarned > 0
        ? (this.rewButton.enabled = !0)
        : (this.rewButton.enabled = !1),
      Game.instance.currLevel - 1 == 0
        ? (this.levelnum.element.text = "TUTORIAL COMPLETED!")
        : (this.levelnum.element.text =
            "LEVEL " +
            (Game.instance.currLevel - 1).toString() +
            " COMPLETED!");
  }),
  (UiCompleted.prototype.update = function (e) {
    ...
    (this.counterTimer += e),
      this.playSoundDelay > 0 &&
        ((this.playSoundDelay -= e),
        this.playSoundDelay <= 0 &&
          (0 == Game.instance.resultType
            ? (GameAudio.play("gamewin"),
              this.createSerpentines(15, new pc.Vec3(0, 25, 0), 150))
            : 1 == Game.instance.resultType && GameAudio.play("gamefail"))),
      this.counterTimer > 0.75 &&
        (this.counterId++,
        (this.counterTimer = 0),
        1 == this.counterId
          ? (Game.instance.moneyEarned > 0 && GameAudio.playEx("counter", 1),
            (this.earned.script.counterText.changingSpeed =
              3 * Game.instance.moneyEarned))
          : 2 == this.counterId ||
            (3 == this.counterId &&
              (Game.instance.totalEarned > 0 && GameAudio.playEx("counter", 1),
              (this.total.script.counterText.changingSpeed =
                3 * Game.instance.totalEarned))));
  });
...
UiFailed.attributes.add("title", { type: "entity" }),
  ...
  (UiFailed.prototype.onEnableCb = function (e) {
    (this.counterTimer = 0),
      (this.counterId = 0),
      Game.wasBonusLevel
        ? ((Game.instance.gotReviveChance = !1),
          (e = !0),
          (this.title.element.text = "NO BONUS"),
          (this.rebut.enabled = !1),
          (this.contbut.enabled = !0))
        : ((this.title.element.text = "GAME OVER"),
          (this.rebut.enabled = !0),
          (this.contbut.enabled = !1)),
      !Game.instance.gotReviveChance || e || Game.bonusLevel
        ? ((this.revive.enabled = !1),
          (this.gameover.enabled = !0),
          this.earned.script.counterText.setValue(
            0,
            Game.instance.moneyEarned,
            500
          ),
          "ground" == Game.instance.gameOverReason
            ? (this.hint.element.text = "DON'T TOUCH THE GROUND")
            : "spikes" == Game.instance.gameOverReason
            ? (this.hint.element.text = "BEWARE OF SPIKES")
            : (this.hint.element.text = " "))
        : ((this.revive.enabled = !0), (this.gameover.enabled = !1));
  }),
...
UnlockButton.attributes.add("price", { type: "entity" }),
  ...
  (UnlockButton.prototype.update = function (t) {
    ...
    if (e > 0) {
      if (((this.count = e), this.count >= 1e3)) {
        ...
        (n = Math.floor(n / 100)),
          (this.price.element.text =
            n > 0
              ? "$ " +
                Math.floor(this.count / 1e3).toString() +
                "." +
                n.toString() +
                "k"
              : "$ " + Math.floor(this.count / 1e3).toString() + "k");
      ...
      this.count > Game.instance.money
        ? ((this.entity.script.myButton.clickable = !1),
          (this.grey.enabled = !0))
        : ((this.entity.script.myButton.clickable = !0),
          (this.grey.enabled = !1)),
        ShopController.instance.unlocking &&
          (this.entity.script.myButton.clickable = !1),
        (this.entity.enabled = !0);
...
(UiMainMenu.prototype.initialize = function () {
  ...
  (UiMainMenu.prototype.onEnable = function () {
    1 == Game.instance.currLevel && (UiMainMenu.hideCap = !1),
      UiMainMenu.hideCap
        ? ((this.caption.enabled = !1), Game.instance.setupPlayingCamera())
        : (this.caption.enabled = !0),
  ...
  (GameHint.prototype.initialize = function () {
    (this.startPos = this.entity.getLocalPosition().clone()),
      ...
      this.entity.setLocalPosition(
        this.startPos.x,
        this.startPos.y - this.deltaMoveY,
        this.startPos.z
      ),
      (this.shown = !1);
  }),
  ...
  pc.script.createLoadingScreen(function (A) {
    var g,
      ...
      updateLogo = function () {
        ...
        logo &&
          ((logo.style.left = 0.5 * (A - logoSize) + "px"),
          (logo.style.top =
            0.5 * (g - (logoSize / logoW) * logoH - 200) + "px")),
          logo2 &&
            ((logo2.style.left = 0.5 * (A - logo2Size) + "px"),
            (logo2.style.top = 0.75 * (g - logo2Size) + "px")),
          bg &&
            ((bg.style.left = "0px"),
            (bg.style.top = "0px"),
            (bg.style.width = A + "px"),
        ...
        C &&
          ((C.style.left = 0.5 * (A - 170) + "px"),
          (C.style.top = 0.5 * g + 50 + "px"));
      };
    (g = [
      "body {",
      ...
      "    height: 16px;",
      "    width: 170px;",
      "    background-color: #332d7c;",
      "}",
      "#progress-bar {",
      "    width: 0%;",
      "border-radius: 25px;",
      "    height: 100%;",
      "background: linear-gradient(#fff188, #ffdd6c);",
      "}",
      ...
      A.on("preload:progress", function (A) {
        ...
        g &&
          ((A = Math.min(1, Math.max(0, A))), (g.style.width = 100 * A + "%"));
      }),
      A.on("start", function () {
        // Delay splash screen removal to ensure game is fully loaded
        setTimeout(function() {
      ...
      this.alpha < 0 &&
        (this.beta <= 0
          ? ((this.tm2 = this.app.root.findByName("uiOverlay")),
            ...
            (this.l.enabled = !0),
            Game.instance.pause(!0))
          : ((this.alpha = 60 + t), this.beta--));
    var a = Math.floor(this.alpha);
    this.tm.text =
      a >= 10
        ? this.beta.toString() + ":" + a.toString()
        : this.beta.toString() + ":0" + a.toString();
  });
...
(Collisions.prototype.initialize = function () {
  (this.colInstance = this),
    ...
    (this.debugPos = 1),
    (this.type = -1),
    (this.debugCollisionsField = this.entity.findByName(
      "debugCollisionsField"
    )),
    (this.noDeadCollisions = this.entity.findByName("noDeadCollisions")),
  ...
  (Collisions.prototype.updateBoundRadius = function (i) {
    ...
    if (
      (s >= 0
        ? Math.floor(e) > 9
          ? (this.debugCollisions.text =
              Math.ceil(0.0166 * (s - e)).toString() +
              ":" +
          ...
          : (this.debugCollisions.text =
              ...
              ":0" +
              Math.floor(e).toString())
        : (this.debugPos < 0 && (this.debugPos = 0),
          this.noDeadCollisions.setLocalPosition(
            0,
            this.debugPos * this.debugPos * 1080 * 2,
            0
          ),
  ...
  (Collisions.prototype.checkAllCollisions = function (i) {
    for (var s, o, t = 0; t < Collisions.polygons.length; t++)
      if (
        ((s = Collisions.polygons[t]),
        !(Collisions.polySum > 613) &&
          s.enabled &&
          s.entity.enabled &&
          s != this &&
          s.colGroup == i &&
        ...
        if (s.zSize <= 0) {
          ...
          this.pos.z < s.pos.z - 0.5 * s.zSize ||
          this.pos.z > s.pos.z + 0.5 * s.zSize
        )
          continue;
        (o =
          (this.boundRadius + s.boundRadius) *
          (this.boundRadius + s.boundRadius)),
          Collisions.tempVec.copy(s.pos),
          Collisions.tempVec.sub(this.pos),
          Collisions.tempVec.lengthSq() >= o ||
            (this.checkCollision(s) &&
              this.entity.fire("polygon:collision", s));
      }
  });
function dj_place(A, i, g, E, I, e) {
  ...
  e
    ? ((a.elem.style.left =
        loadingDisplayParams.width * (i + E / defaultScreenSizePx.width) -
        0.5 * parseInt(a.elem.style.width, 10) +
        "px"),
      (a.elem.style.top =
        loadingDisplayParams.height * (g + I / defaultScreenSizePx.height) -
        0.5 * parseInt(a.elem.style.height, 10) +
        "px"))
    : ((a.elem.style.left =
        loadingDisplayParams.width * (i + E / defaultScreenSizePx.width) +
        "px"),
...
function dg_updateElements() {
  ...
  dj_place("img_loadingbar", 0.5, 1, 0, -120, !0),
    loadingDisplayParams.width > loadingDisplayParams.height
      ? (dj_scaleRelative("img_pcLogoLoading", 0.45 * 0.65, !0, !1),
        loadingElements.img_loadingbar &&
          (loadingElements.img_loadingbar.elem.style.width =
            0.5 * loadingDisplayParams.width + "px"))
      : (dj_scaleRelative("img_pcLogoLoading", 0.27 * 0.65, !0, !1),
        loadingElements.img_loadingbar &&
          (loadingElements.img_loadingbar.elem.style.width =
            0.6 * loadingDisplayParams.width + "px"));
}
...
function dg_hide_loading_pls() {
  for (var A in ((loadingHidden = !0), loadingElements))
    loadingElements.hasOwnProperty(A) &&
      dg_hideElement(loadingElements[A].elem);
  // Don't remove splash screen immediately - let it fade naturally
...
function dj_place(g, A, C, I, e, a) {
  ...
  a
    ? ((i.elem.style.left =
        loadingDisplayParams.width * (A + I / defaultScreenSizePx.width) -
        0.5 * parseInt(i.elem.style.width, 10) +
        "px"),
      (i.elem.style.top =
        loadingDisplayParams.height * (C + e / defaultScreenSizePx.height) -
        0.5 * parseInt(i.elem.style.height, 10) +
        "px"))
    : ((i.elem.style.left =
        loadingDisplayParams.width * (A + I / defaultScreenSizePx.width) +
        "px"),
...
function dg_updateElements() {
  ...
  dj_place("img_loadingbar", 0.5, 1, 0, -120, !0),
    loadingDisplayParams.width > loadingDisplayParams.height
      ? (dj_scaleRelative("img_pcLogoLoading", 0.25, !0, !1),
        loadingElements.img_loadingbar &&
          (loadingElements.img_loadingbar.elem.style.width =
            0.5 * loadingDisplayParams.width + "px"))
      : (dj_scaleRelative("img_pcLogoLoading", 0.18, !0, !1),
        loadingElements.img_loadingbar &&
          (loadingElements.img_loadingbar.elem.style.width =
            0.6 * loadingDisplayParams.width + "px"));
}
...
function dg_hide_loading_pls() {
  for (var g in ((loadingHidden = !0), loadingElements))
    loadingElements.hasOwnProperty(g) &&
      dg_hideElement(loadingElements[g].elem);
  // Don't remove splash screen immediately - let it fade naturally
  // var A = document.getElementById("application-splash-wrapper");
...
(Sdkmanager.instance = null),
    ...
    (Sdkmanager.instance = this),
      ...
      this.sdktype == Sdkmanager.SDK_TESTING
        ...
        ? ((this.crazysdk = window.CrazyGames.CrazySDK.getInstance()),
          ...
          this.crazysdk.addEventListener(
            "adStarted",
            this.onAdStarted.bind(this)
          ),
          this.crazysdk.addEventListener(
            "adFinished",
            this.onAdFinished.bind(this)
          ),
  ...
  (Sdkmanager.prototype.showAd = function (e, t = 1, a = null) {
    ...
    s &&
      ...
      (this.onAdSuccess = a),
      this.sdktype == Sdkmanager.SDK_TESTING
        ? t == Sdkmanager.AD_INTERSTITIAL
          ? (this.gameMute(), (this.testInterstitialAdDelay = 2))
          : t == Sdkmanager.AD_REWARDED &&
            (this.gameMute(), (this.testRewardedAdDelay = 3))
        : this.sdktype == Sdkmanager.SDK_CRAZYGAMES
        ? (t == Sdkmanager.AD_INTERSTITIAL
        ...
        : this.sdktype == Sdkmanager.SDK_COOLMATH &&
          (t == Sdkmanager.AD_INTERSTITIAL
            ? window.cmgAdBreak && window.cmgAdBreak()
            : t == Sdkmanager.AD_REWARDED &&
              window.cmgRewardAds &&
              window.cmgRewardAds()));
  }),
  (Sdkmanager.prototype.update = function (e) {
    this.sdktype == Sdkmanager.SDK_TESTING &&
      (this.testRewardedAdDelay > 0
        ? ((this.testRewardedAdDelay -= e),
          this.testRewardedAdDelay <= 0 &&
            (this.gameUnmute(), this.onAdSuccess && this.onAdSuccess()))
        : this.testInterstitialAdDelay > 0 &&
          ((this.testInterstitialAdDelay -= e),
...
UiSerpantine.attributes.add("colors", { type: "rgba", array: !0 }),
  ...
  (UiSerpantine.prototype.update = function (t) {
    (this.rotScale += this.rotScaleState * t),
      this.rotScale > 1 &&
        this.rotScaleState > 0 &&
        ((this.rotScale = 1), (this.rotScaleState = -this.rotScaleState)),
      this.rotScale < 0 &&
        this.rotScaleState < 0 &&
        ((this.rotScale = 0), (this.rotScaleState = -this.rotScaleState)),
      this.entity.setLocalScale(1, this.rotScale, 1),
